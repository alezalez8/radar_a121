...
// The defines for detector_status fields (masks and bit-positions)
...
// The defines for presence_result fields (masks and bit-positions)
...
#define PRESENCE_REG_APPLICATION_ID_ENUM_EXAMPLE_DOOR_OPEN_DETECTION 5U
...
/**
 * Read:
 * A measure of the amount of fast motion detected. Just like the
 * configuration register intra_detection_threshold, this field is a
...
/**
 * Read:
 * A measure of the amount of slow motion detected. Just like the
 * configuration register inter_detection_threshold, this field is a
 * factor 1000 larger than the RSS value.
 */
