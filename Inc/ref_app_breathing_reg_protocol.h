...
// The defines for app_status fields (masks and bit-positions)
...
// The defines for breathing_result fields (masks and bit-positions)
...
#define REF_APP_BREATHING_REG_APPLICATION_ID_ENUM_EXAMPLE_DOOR_OPEN_DETECTION 5U
