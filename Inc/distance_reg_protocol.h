...
// The defines for distance_result fields (masks and bit-positions)
...
#define DISTANCE_REG_APPLICATION_ID_ENUM_EXAMPLE_CARGO 4U
#define DISTANCE_REG_APPLICATION_ID_ENUM_EXAMPLE_DOOR_OPEN_DETECTION 5U
